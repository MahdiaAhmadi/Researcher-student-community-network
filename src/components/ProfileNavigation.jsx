...
const ProfileNavigation = ({ currentTab }) => {
  return (
    <div className="bg-zinc-300 shadow flex items-center justify-between space-x-4 py-2 max-w-5xl h-fit rounded-md text-black">
      <div>
        ...
        <Link className="p-1 hover:bg-black hover:text-white rounded-md" href="/profile/followers">Following</Link>
